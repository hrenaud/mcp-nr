...
>
> **En cours de remédiation** (branche `fix/infra-parity-and-auth-failsafe`). **22/51 faits** (Tasks 1, 2, 4, 5, 7, 8, 9, 11 + convergence infra & fail-safe auth hors review). **Reste 9 constats** gated sur décision (Task 3 dédup output_schema, Task 6 précision analyseur, Task 10 version dynamique) ; 12 faux positifs / non-actions justifiées ; le reste informatif. Voir [§7.1](#71-statistiques) et [§8](#8-travaux-additionnels-hors-review).
...
| Statut                                     | Count | #s                                                                                                                                            |
| ------------------------------------------ | ----- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| ✅ **Fait**                                | 22    | 1, 2, 3, 6, 7, 11, 16, 17, 18, 25, 26, 31, 33, 34, 35, 37, 39, 41, 44, 47, 49, 50 (+ fail-safe auth & parité infra, **hors review** — cf. §8) |
| ⬜ **À faire** (gated décision)            | 9     | Task 3 : 14, 21, 46, 51 · Task 10 : 12, 20, 30 · Task 6 : 23, 24                                                                              |
| 🟦 **Faux positif / non-action justifiée** | 12    | 4, 5, 8, 9, 13, 19, 22, 28, 32, 38, 45, 48                                                                                                    |
