...
>
> **En cours de remédiation** (branche `fix/infra-parity-and-auth-failsafe`). **24/51 faits** (Tasks 1, 2, 4, 5, 6, 7, 8, 9, 11 + convergence infra & fail-safe auth hors review). **Reste 4 constats** : **Task 3** (dédup des tables d'outils — #14/#21/#46/#51). 15 faux positifs / non-actions justifiées ; 8 informatifs. Voir [§7.1](#71-statistiques) et [§8](#8-travaux-additionnels-hors-review).
...
| Statut                                     | Count | #s                                                                                                                                                    |
| ------------------------------------------ | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| ✅ **Fait**                                | 24    | 1, 2, 3, 6, 7, 11, 16, 17, 18, 23, 24, 25, 26, 31, 33, 34, 35, 37, 39, 41, 44, 47, 49, 50 (+ fail-safe auth & parité infra, **hors review** — cf. §8) |
| ⬜ **À faire**                             | 4     | Task 3 (dédup tables d'outils) : 14, 21, 46, 51                                                                                                       |
